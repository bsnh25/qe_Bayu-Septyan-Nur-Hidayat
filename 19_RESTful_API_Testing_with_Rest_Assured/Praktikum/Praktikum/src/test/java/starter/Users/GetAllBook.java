...
public class GetAllBook {
    private static String url, title;

    public static void setUrlBook(){
        url = "https://demoqa.com/BookStore/v1/Books";
    }

    public static String requestGetAllOfBook(){
        ...
        title = lastResponse().body().path("[0].title");
        return title;
    }

    public static void validateAllOfTheInfromationOfTheBook(){
