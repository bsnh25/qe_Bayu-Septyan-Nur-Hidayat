...
public class AndroidDriverInit {
    ...
    public static void initialization(){
        ...
        caps.setCapability("platformVersion", "11"); //ini diubah
        caps.setCapability("platformName", "Android");
        caps.setCapability("automationName", "UiAutomator2");
        caps.setCapability("app", "D:\\File Baru\\Kuliah\\Quality Engineer\\qe_Bayu-Septyan-Nur-Hidayat\\26_Mobile_Testing\\Praktikum\\sample-mobile-automation\\src\\test\\resources\\application\\calculator-alta-qe.apk"); //ini diubah
